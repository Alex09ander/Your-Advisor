    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: mIconPath != null ? Padding(
          ...
          child: Row(
              children: [
                Expanded(child: Text(text, style: TextStyle(color: textColor, fontSize: fontSize, fontWeight: FontWeight.bold, ),)),
                SvgPicture.asset(mIconPath!, width: 25, height: 25, color: iconColor,),
              ]
          ),
        ) : Center(
