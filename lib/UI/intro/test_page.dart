                      ...
                      onTap: () async {
                        if (clickCount == 0 && btn != 0){
                          ...
                          Map<String, dynamic> dane = {
                            'Pytanie': {'Pytanie 1', 'Pytanie 2', 'Pytanie 3', 'Pytanie 4', 'Pytanie 5', 'Pytanie 6'},
                            'Odpowiedź': {answer1, answer2, answer3, answer4, answer5, answer6},
                          };

                          String jsonString = jsonEncode(dane); // Konwertuj mapę na String JSON

                          await file.writeAsString(jsonString); // Zapisz JSON do pliku
